...
#             for tail in samples:
#
#                 heads = [head for head in samplesBySample[tail] if
#                          self.distanceToSamples[(head, tail)] < self.distanceLimit]
#
#                 for head in heads:
#                     if head is not tail:
...
#             return (tail.values[tail.samples.positions[self.column]] -
#                     head.values[head.samples.positions[self.column]]) ** 2
#
